          ...
          <div className="borda__ingredientes">
            ...
            <div className="ingrediente">
              <div className="valor__ingrediente">
                <p className="ingrediente__name">{products[0].ingredients[0].itens[0].nm_item}</p>
                <p className="ingrediente_value">{products[0].ingredients[0].itens[0].vl_item}</p>
              </div>
            ...
            <div className="ingrediente">
              <div className="valor__ingrediente">
                <p className="ingrediente__name">{products[0].ingredients[0].itens[1].nm_item}</p>
                <p className="ingrediente_value">{products[0].ingredients[0].itens[1].vl_item}</p>
              </div>
              <div className="adicao__ingrediente">
                <button>
                  <img src={sinalMenos} alt="" />
            ...
            <div className="ingrediente">
              <div className="valor__ingrediente">
                <p className="ingrediente__name">{products[0].ingredients[0].itens[2].nm_item}</p>
                <p className="ingrediente_value">{products[0].ingredients[0].itens[2].vl_item}</p>
              </div>
              <div className="adicao__ingrediente">
                <button>
                  <img src={sinalMenos} alt="" />
            ...
            <div className="ingrediente">
              <div className="valor__ingrediente">
                <p className="ingrediente__name">{products[0].ingredients[0].itens[3].nm_item}</p>
                <p className="ingrediente_value">{products[0].ingredients[0].itens[3].vl_item}</p>
              </div>
              <div className="adicao__ingrediente">
                <button>
                  <img src={sinalMenos} alt="" />
            ...
            <div className="talher">
              <p>{products[0].ingredients[1].group}</p>
            </div>
